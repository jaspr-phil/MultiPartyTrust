...
//                            "kernel-full," +
        ...
        jaspr.provfsm.treeworkflowsim.TrainTestParams params = new TrainTestParams(args);

        jaspr.provfsm.treeworkflowsim.TrainTestSimulation simulation = new jaspr.provfsm.treeworkflowsim.TrainTestSimulation(params);
