...
public class DistributionBlock extends RedistributionBlock {

    public DistributionBlock(int numInputs, int numOutputs, List<ITask> allTasks) {
        super(numInputs, numOutputs, numInputs, allTasks); //inputs, outputs, tasks
//        super(numInputs, numOutputs, numInputs, allTasks); //inputs, outputs/tasks, tasks
    }
